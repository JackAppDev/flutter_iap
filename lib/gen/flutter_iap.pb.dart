...
class IAPProduct extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('IAPProduct')
    ...
    ..aOS(3, 'localizedTitle')
    ..aOS(4, 'localizedDescription')
    ..aOS(5, 'price')
    ..aOS(6, 'priceLocale')
    ..aOS(7, 'localizedPrice')
    ..aOB(8, 'isDownloadable')
    ..aOS(9, 'downloadContentLengths')
    ..aOS(10, 'downloadContentVersion')
    ..aOS(11, 'freeTrialPeriod')
    ..aOS(20, 'subscriptionPeriod')
    ..aOS(21, 'introductoryPrice')
    ..aOS(22, 'introductoryPricePeriod')
    ..aOS(23, 'introductoryPriceCycles')
  ;
