...
const IAPPurchase$json = const {
  ...
  '2': const [
    ...
    const {'1': 'originalJson', '3': 3, '4': 1, '5': 9, '10': 'originalJson'},
    const {'1': 'orderId', '3': 4, '4': 1, '5': 9, '10': 'orderId'},
    const {'1': 'packageName', '3': 5, '4': 1, '5': 9, '10': 'packageName'},
    const {'1': 'purchaseTime', '3': 6, '4': 1, '5': 3, '10': 'purchaseTime'},
    const {'1': 'purchaseToken', '3': 7, '4': 1, '5': 9, '10': 'purchaseToken'},
  ],
};
...
const IAPProduct$json = const {
  ...
  '2': const [
    ...
    const {'1': 'localizedTitle', '3': 3, '4': 1, '5': 9, '10': 'localizedTitle'},
    const {'1': 'localizedDescription', '3': 4, '4': 1, '5': 9, '10': 'localizedDescription'},
    const {'1': 'price', '3': 5, '4': 1, '5': 9, '10': 'price'},
    const {'1': 'priceLocale', '3': 6, '4': 1, '5': 9, '10': 'priceLocale'},
    const {'1': 'localizedPrice', '3': 7, '4': 1, '5': 9, '10': 'localizedPrice'},
    const {'1': 'isDownloadable', '3': 8, '4': 1, '5': 8, '10': 'isDownloadable'},
    const {'1': 'downloadContentLengths', '3': 9, '4': 1, '5': 9, '10': 'downloadContentLengths'},
    const {'1': 'downloadContentVersion', '3': 10, '4': 1, '5': 9, '10': 'downloadContentVersion'},
    const {'1': 'freeTrialPeriod', '3': 11, '4': 1, '5': 9, '10': 'freeTrialPeriod'},
    const {'1': 'subscriptionPeriod', '3': 20, '4': 1, '5': 9, '10': 'subscriptionPeriod'},
    const {'1': 'introductoryPrice', '3': 21, '4': 1, '5': 9, '10': 'introductoryPrice'},
    const {'1': 'introductoryPricePeriod', '3': 22, '4': 1, '5': 9, '10': 'introductoryPricePeriod'},
    const {'1': 'introductoryPriceCycles', '3': 23, '4': 1, '5': 9, '10': 'introductoryPriceCycles'},
  ],
};
